...
const PASSWORD = 'vG2YuPesl9Byqj1e'
const DB_NAME = 'pasaletras'
const MONGO_URI_ATLAS = `mongodb+srv://${USER}:${PASSWORD}@cluster0.fj3d1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
